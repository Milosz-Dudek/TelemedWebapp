...
urlpatterns = [
    ...
    path('my_account/edit_rehabilitator/<int:pk>/', views.edit_rehabilitator, name='edit_rehabilitator'),
    path('my_account/edit_patient/<int:pk>/', views.edit_patient, name='edit_patient')
]
